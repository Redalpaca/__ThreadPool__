...
'cookie':'_uuid=A88D5A79-4B3B-A239-B24F-3248A1651010A911511infoc; buvid3=E70AFEDB-A19B-66A8-5D4A-40F260FE0C6311932infoc; b_nut=1661084412; buvid_fp_plain=undefined; nostalgia_conf=-1; hit-dyn-v2=1; CURRENT_BLACKGAP=0; LIVE_BUVID=AUTO3716614203275903; i-wanna-go-back=-1; b_ut=5; blackside_state=1; buvid4=C2135F30-E5E0-2782-1E45-EF9D8634191311932-022082120-Rxh3f6X2kA%2FJ8vhmY%2FvbNA%3D%3D; fingerprint3=90af111f73f1ee3654a49debd2df4397; is-2022-channel=1; rpdid=|(umJmYJmJlJ0J\'uYY)l~kY~u; DedeUserID=35671002; DedeUserID__ckMd5=d69f732e9248e565; header_theme_version=CLOSE; CURRENT_FNVAL=4048; hit-new-style-dyn=1; home_feed_column=4; CURRENT_PID=21880c60-cd2d-11ed-acbb-ab42de6de53b; CURRENT_QUALITY=116; fingerprint=2c2a060c48387ea6ece424785261fc66; PVID=1; buvid_fp=2c2a060c48387ea6ece424785261fc66; SESSDATA=560364d9%2C1701577778%2C88164%2A61; bili_jct=a022b56155f68e169575a3c812715355; sid=7mxoebcx; bp_video_offset_35671002=804744590582088000; b_lsid=D57BBC810_18899DD1411',
...
class BiliVideo(object):
    ...
    def __init__(self, bvid: str, BiliHeaders: dict= BiliUniHeaders):
        ...
        if re.search(BiliVideo.StatusModeStr, str(self.res.status_code)) == None:
            print('Illigal bvid:'+bvid)
            return None   
